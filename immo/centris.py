...
from shared import click_by_id, setup, alreadySeen, addToAlreadySeen, select_parc_ex, select_type, \
    startSearch, selectPrice
...
onlyTheNew = []
for url in urls:
    if alreadySeen(url, "/mnt/Photos/duplex"):
        print("seen")
    else:
...
addToAlreadySeen(urls, "/mnt/Photos/duplex")
driver.quit()
