...
// Display controls.
render_object = "assembled"; // "assembled", "top-and-door", "bottom", "rod"
layout_gap_mm = 20;
show_hinge_rod = true;
...
module top_and_door_printable() {
    ...
    translate([0, -(door_center_y_mm - door_half_height_mm + layout_gap_mm), 0])
        door_part();
}
...
if (render_object == "assembled")
    ...
    assert(false, "render_object must be one of: assembled, top-and-door, bottom, rod");
